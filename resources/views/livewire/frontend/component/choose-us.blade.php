        ...
        <div class="bb ze ki xn wq">
            <div class="tc wf gg qq">
                ...
                <div class="animate_right jn/2">
                    ...
                    <h2 class="fk vj zp pr kk wm qb">Collaborate with peers to make more impact.</h2>
                    <p class="uo">Through showcasing the ideas that individuals have they can be turned into working
                        projects.
                    </p>
